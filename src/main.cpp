...
score();
	...
	chassis.moveToPose(-105, -50, 268, 2000, {.minSpeed = 80, .earlyExitRange = 0.3});//Frank change: -45=>-50, 2=>0.3
...
score();
	...
	chassis.moveToPose(-110, -45, 268, 2000, {.minSpeed = 80, .earlyExitRange = 2});
	chassis.waitUntilDone();
	pros::delay(200);
...
pros::delay(2000);
	...
	chassis.moveToPose(50, 30, 85,1400, {.lead = 0.1, .maxSpeed=110,.minSpeed = 90, .earlyExitRange = 3});//Frank change: 89=>87, 1600=>1400
